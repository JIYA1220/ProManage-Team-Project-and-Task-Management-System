...
import { GoDatabase, GoProject } from "react-icons/go";
			...
			<div className="nav-links">
				<div>
					<Link
						...
						className={`nav-link ${
							pathname === "/" && dashboardSection == "board" && "nav-active"
						}`}
					>
                    ...
                    <Link
						to={"/projects"}
						className={`nav-link ${
							pathname.startsWith("/projects") && "nav-active"
						}`}
					>
						<AiOutlineProject fontSize={22} />
						<span>Projects</span>
					</Link>
					<span
						onClick={() =>
